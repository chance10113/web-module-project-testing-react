...
test("renders Loading component when prop show is null", () => {
  // Arrange: Render the Show component without testShow
  render(<Show show={null} selectedSeason={"none"} />);
  // Act: Define loading (testId)
  const loading = screen.getByTestId(/loading-container/i);
  // Assert: Expect loading to exist
...
//2. Test that the Show component renders when your test data is passed in through show and
// "none" is passed in through selectedSeason.

//3. Test that the Loading component displays when null is passed into the show prop
// (look at the Loading component to see how to test for it's existance)

//4. Test that when your test data is passed through the show prop,
// the same number of season select options appears as there are seasons in your test data.
...
// userEvent reference materials to see how to trigger a selection.

//6. Test that the episode component DOES NOT render when the selectedSeason props is "none" and
